...
export type GetApplicationErrorsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetApplicationErrorsQuery = (
  { __typename?: 'Query' }
  & Pick<Query, 'errorMessage'>
);
...
export type GetActiveProjectIdQueryVariables = Exact<{ [key: string]: never; }>;


export type GetActiveProjectIdQuery = (
  { __typename?: 'Query' }
  & Pick<Query, 'activeProjectId'>
);
...
export const GetApplicationErrorsDocument = gql`
...
/**
 * __useGetApplicationErrorsQuery__
 *
 * To run a query within a React component, call `useGetApplicationErrorsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetApplicationErrorsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetApplicationErrorsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetApplicationErrorsQuery(baseOptions?: Apollo.QueryHookOptions<GetApplicationErrorsQuery, GetApplicationErrorsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetApplicationErrorsQuery, GetApplicationErrorsQueryVariables>(GetApplicationErrorsDocument, options);
      }
export function useGetApplicationErrorsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetApplicationErrorsQuery, GetApplicationErrorsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetApplicationErrorsQuery, GetApplicationErrorsQueryVariables>(GetApplicationErrorsDocument, options);
        }
export type GetApplicationErrorsQueryHookResult = ReturnType<typeof useGetApplicationErrorsQuery>;
export type GetApplicationErrorsLazyQueryHookResult = ReturnType<typeof useGetApplicationErrorsLazyQuery>;
export type GetApplicationErrorsQueryResult = Apollo.QueryResult<GetApplicationErrorsQuery, GetApplicationErrorsQueryVariables>;
...
export const GetActiveProjectIdDocument = gql`
...
/**
 * __useGetActiveProjectIdQuery__
 *
 * To run a query within a React component, call `useGetActiveProjectIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetActiveProjectIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetActiveProjectIdQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetActiveProjectIdQuery(baseOptions?: Apollo.QueryHookOptions<GetActiveProjectIdQuery, GetActiveProjectIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetActiveProjectIdQuery, GetActiveProjectIdQueryVariables>(GetActiveProjectIdDocument, options);
      }
export function useGetActiveProjectIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetActiveProjectIdQuery, GetActiveProjectIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetActiveProjectIdQuery, GetActiveProjectIdQueryVariables>(GetActiveProjectIdDocument, options);
        }
export type GetActiveProjectIdQueryHookResult = ReturnType<typeof useGetActiveProjectIdQuery>;
export type GetActiveProjectIdLazyQueryHookResult = ReturnType<typeof useGetActiveProjectIdLazyQuery>;
export type GetActiveProjectIdQueryResult = Apollo.QueryResult<GetActiveProjectIdQuery, GetActiveProjectIdQueryVariables>;
